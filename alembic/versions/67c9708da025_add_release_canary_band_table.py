...
def upgrade():
    ...
    op.create_table('release_canary_band',
    ...
    op.add_column('signal', sa.Column('release_canary_band_id', postgresql.UUID(as_uuid=True), nullable=False))
    op.create_foreign_key(None, 'signal', 'release_canary_band', ['release_canary_band_id'], ['id'])
